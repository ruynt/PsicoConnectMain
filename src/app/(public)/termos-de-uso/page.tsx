...
export const metadata = {
  title: "Termos de Uso | PsicoConnect",
  description:
    "Regras de uso, responsabilidades e limites da plataforma PsicoConnect.",
};
    ...
    <main className={styles.legalPage}>
      <section className={styles.heroSection}>
        <div className={styles.heroInner}>
          ...
          <div className={styles.heroCard}>
            <span className={styles.badge}>Termos de Uso</span>

            <h1>Termos de Uso</h1>

            <p>Regras gerais de acesso, responsabilidades dos usuários, limites da plataforma e condições de uso do PsicoConnect.</p>
      ...
      <section className={styles.contentSection}>
        <div className={styles.singleDocumentInner}>
          <LegalTabs active="termos" />

          <DocumentContent blockId="termos" />
        </div>
      </section>
    </main>
  );
